    ...
    <div class="flex items-end justify-end mt-5 gap-x-2">
      <form method="post" action="{{ route('profile.delete-profile-picture') }}">
        ...
        <button type="submit"
          ...
          @if (session('status') === 'picture-deleted')
            ...
            <svg x-data="{ show: false }" x-show="show" x-transition x-init="setTimeout(() => show = true, 2000)"
              class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
