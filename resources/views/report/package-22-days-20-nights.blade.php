        ...
        <div
            ...
            <div>
              <div class="inline-flex gap-x-2">
                ...
                <a class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-gray-800 border border-gray-200 rounded-lg shadow-sm gap-x-2 hover:bg-gray-900 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                  href="{{ route('report.export-22-days-20-nights') }}">
          ...
          <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
              @php
                $count = 1;
              @endphp
              @foreach ($package22Days20Nights as $package22Days20NightsData)
                <tr>
                  <!-- No. -->
                  ...
                  <td class="align-top size-px whitespace-nowrap">
                    <div class="py-3 ps-6">
                      <span class="text-sm text-gray-600 dark:text-neutral-400">
                        {{ $package22Days20NightsData->name }}
                      </span>
                    </div>
                  </td>
                  <!-- End Name -->
                  ...
                  <td class="align-top size-px whitespace-nowrap">
                    <div class="py-3 ps-6">
                      <span class="text-sm text-gray-600 dark:text-neutral-400">
                        {{ $package22Days20NightsData->year }}
                      </span>
                    </div>
                  </td>
                  <!-- End Year -->
                  ...
                  <td class="align-top size-px whitespace-nowrap">
                    <div class="py-3 ps-6">
                      <span class="text-sm text-gray-600 dark:text-neutral-400">
                        RM {{ number_format($package22Days20NightsData->package_22_20->room_4_5, 0, ',') }}
                      </span>
                    </div>
                  </td>
                  <!-- End 4 or 5 People -->
                  ...
                  <td class="align-top size-px whitespace-nowrap">
                    <div class="py-3 ps-6">
                      <span class="text-sm text-gray-600 dark:text-neutral-400">
                        RM {{ number_format($package22Days20NightsData->package_22_20->room_3, 0, ',') }}
                      </span>
                    </div>
                  </td>
                  <!-- End 3 People -->
                  ...
                  <td class="align-top size-px whitespace-nowrap">
                    <div class="py-3 ps-6">
                      <span class="text-sm text-gray-600 dark:text-neutral-400">
                        RM {{ number_format($package22Days20NightsData->package_22_20->room_2, 0, ',') }}
                      </span>
                    </div>
                  </td>
                  <!-- End 2 People -->
                  ...
                  <td class="h-px align-top w-72 min-w-72">
                    <div class="py-3 ps-6">
                      <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">
                        {{ $package22Days20NightsData->hotel_makkah->name }}
                      </span>
                      <span class="block text-sm text-gray-500 dark:text-neutral-500">
                        {{ $package22Days20NightsData->hotel_makkah->location }}
                      </span>
                      <div class="flex items-center mt-2 text-xs text-gray-500 dark:text-neutral-500">
                        ...
                        {{ $package22Days20NightsData->hotel_makkah->distance }} Meters
                      </div>
                      <div class="flex items-center mt-1 text-xs text-gray-500 dark:text-neutral-500">
                        ...
                        {{ $package22Days20NightsData->hotel_makkah->rating }} Rating
                      </div>
                    </div>
                  </td>
                  <!-- End Hotel Makkah -->
                  ...
                  <td class="h-px align-top w-72 min-w-72">
                    <div class="py-3 ps-6">
                      <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">
                        {{ $package22Days20NightsData->hotel_madinah->name }}
                      </span>
                      <span class="block text-sm text-gray-500 dark:text-neutral-500">
                        {{ $package22Days20NightsData->hotel_madinah->location }}
                      </span>
                      <div class="flex items-center mt-2 text-xs text-gray-500 dark:text-neutral-500">
                        <svg class="flex-shrink-0 size-3.5 me-2 mb-0.5" xmlns="http://www.w3.org/2000/svg"
                          width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        ...
                        {{ $package22Days20NightsData->hotel_madinah->distance }} Meters
                      </div>
                      <div class="flex items-center mt-1 text-xs text-gray-500 dark:text-neutral-500">
                        <svg class="flex-shrink-0 size-3.5 me-2 mb-0.5" xmlns="http://www.w3.org/2000/svg"
                          width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        ...
                        {{ $package22Days20NightsData->hotel_madinah->rating }} Rating
                      </div>
                    </div>
                  </td>
                  <!-- End Hotel Madinah -->
                  ...
                  <td class="align-top size-px whitespace-nowrap">
                    <div class="py-3 ps-6">
                      <span class="text-sm text-gray-600 dark:text-neutral-400">
                        {{ $package22Days20NightsData->created_at->format('d F Y') }}
                      </span>
                    </div>
                  </td>
                  <!-- End Created -->
          ...
          <div
            ...
            <div>
              <p class="text-sm text-gray-600 dark:text-neutral-400">
                <span
                  class="font-semibold text-gray-800 dark:text-neutral-200">{{ $package22Days20Nights->count() }}</span>
                results
              </p>
            </div>
            <!-- End Results -->
