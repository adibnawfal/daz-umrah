      ...
      <div class="p-1.5 min-w-full inline-block align-middle">
        <div
            ...
            <div>
              <div class="inline-flex gap-x-2">
                ...
                <a class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-gray-800 border border-gray-200 rounded-lg shadow-sm gap-x-2 hover:bg-gray-900 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                  href="{{ route('report.export-all-user') }}">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
              ...
              @foreach ($allUser as $allUserData)
                <tr>
                  ...
                  <td class="size-px whitespace-nowrap">
                    <div class="py-3 ps-6">
                      @if ($allUserData->profile_img)
                        <img class="inline-block size-[38px] rounded-full ring-2 ring-white dark:ring-gray-800"
                          src="{{ asset('images/users/' . $allUserData->profile_img) }}" alt="Profile Picture">
                      @else
                        <div>
                          <span
                            ...
                            <span class="text-xs font-medium leading-none text-gray-800 dark:text-gray-200">
                              {{ substr($allUserData->first_name, 0, 1) . substr($allUserData->last_name, 0, 1) }}
                            </span>
                          </span>
                        </div>
                      @endif
                  ...
                  <td class="size-px whitespace-nowrap">
                    <div class="py-3 ps-6">
                      <span class="text-sm text-gray-600 dark:text-neutral-400">
                        @if ($allUserData->phone_no)
                          +60{{ $allUserData->phone_no }}
                        @else
                          -
                        @endif
                      </span>
                  ...
                  <td class="size-px whitespace-nowrap">
                    <div class="py-3 ps-6">
                      <span class="text-sm text-gray-600 dark:text-neutral-400">
                        @if ($allUserData->address1)
                          <span class="block">{{ $allUserData->address1 }}</span>
                          <span>{{ $allUserData->address2 }}</span>
                          <span class="block">{{ $allUserData->postal_code }} {{ $allUserData->city }}</span>
                          <span class="block">{{ $allUserData->state }}</span>
                        @else
                          -
                        @endif
                      </span>
                  ...
                  <td class="size-px whitespace-nowrap">
                    <div class="py-3 ps-6">
                      <span class="text-sm text-gray-600 dark:text-neutral-400">
                        {{ $allUserData->created_at->format('d F Y') }}
                      </span>
                    </div>
                  </td>
                  <!-- End Created -->
          ...
          <div
            ...
            <div>
              <p class="text-sm text-gray-600 dark:text-neutral-400">
                <span class="font-semibold text-gray-800 dark:text-neutral-200">{{ $allUserData->count() }}</span>
                results
              </p>
            </div>
            <!-- End Results -->
