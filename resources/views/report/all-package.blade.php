      ...
      <div class="p-1.5 min-w-full inline-block align-middle">
        <div
          ...
          <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
              @php
                $count = 1;
              @endphp
              @foreach ($allPackage as $allPackageData)
                <tr>
                  <!-- No. -->
                  ...
                  <td class="align-top size-px whitespace-nowrap">
                    <div class="py-3 ps-6">
                      @if ($allPackageData->package_12_10_id)
                        <div class="flex items-center gap-x-2">
                          <span class="text-sm font-semibold text-gray-800 dark:text-white">4 or 5 People</span>
                          <span class="text-xs text-gray-500 dark:text-neutral-500">
                            RM {{ number_format($allPackageData->package_12_10->room_4_5, 0, ',') }}
                          </span>
                        </div>
                        <div class="flex items-center gap-x-2">
                          <span class="text-sm font-semibold text-gray-800 dark:text-white">3 People</span>
                          <span class="text-xs text-gray-500 dark:text-neutral-500">
                            RM {{ number_format($allPackageData->package_12_10->room_3, 0, ',') }}
                          </span>
                        </div>
                        <div class="flex items-center gap-x-2">
                          <span class="text-sm font-semibold text-gray-800 dark:text-white">2 People</span>
                          <span class="text-xs text-gray-500 dark:text-neutral-500">
                            RM {{ number_format($allPackageData->package_12_10->room_2, 0, ',') }}
                          </span>
                        </div>
                      @else
                        -
                  ...
                  <td class="align-top size-px whitespace-nowrap">
                    <div class="py-3 ps-6">
                      @if ($allPackageData->package_22_20_id)
                        <div class="flex items-center gap-x-2">
                          <span class="text-sm font-semibold text-gray-800 dark:text-white">4 or 5 People</span>
                          <span class="text-xs text-gray-500 dark:text-neutral-500">
                            RM {{ number_format($allPackageData->package_22_20->room_4_5, 0, ',') }}
                          </span>
                        </div>
                        <div class="flex items-center gap-x-2">
                          <span class="text-sm font-semibold text-gray-800 dark:text-white">3 People</span>
                          <span class="text-xs text-gray-500 dark:text-neutral-500">
                            RM {{ number_format($allPackageData->package_22_20->room_3, 0, ',') }}
                          </span>
                        </div>
                        <div class="flex items-center gap-x-2">
                          <span class="text-sm font-semibold text-gray-800 dark:text-white">2 People</span>
                          <span class="text-xs text-gray-500 dark:text-neutral-500">
                            RM {{ number_format($allPackageData->package_22_20->room_2, 0, ',') }}
                          </span>
                        </div>
                      @else
                        -
                  ...
                  <td class="h-px align-top w-72 min-w-72">
                    <div class="py-3 ps-6">
                      <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">
                        {{ $allPackageData->hotel_makkah->name }}
                      </span>
                      <span class="block text-sm text-gray-500 dark:text-neutral-500">
                        {{ $allPackageData->hotel_makkah->location }}
                      </span>
                      <div class="flex items-center mt-2 text-xs text-gray-500 dark:text-neutral-500">
                        ...
                        {{ $allPackageData->hotel_makkah->distance }} Meters
                      </div>
                      <div class="flex items-center mt-1 text-xs text-gray-500 dark:text-neutral-500">
                        ...
                        {{ $allPackageData->hotel_makkah->rating }} Rating
                      </div>
                    </div>
                  </td>
                  <!-- End Hotel Makkah -->
                  ...
                  <td class="h-px align-top w-72 min-w-72">
                    <div class="py-3 ps-6">
                      <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">
                        {{ $allPackageData->hotel_madinah->name }}
                      </span>
                      <span class="block text-sm text-gray-500 dark:text-neutral-500">
                        {{ $allPackageData->hotel_madinah->location }}
                      </span>
                      <div class="flex items-center mt-2 text-xs text-gray-500 dark:text-neutral-500">
                        <svg class="flex-shrink-0 size-3.5 me-2 mb-0.5" xmlns="http://www.w3.org/2000/svg"
                          width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        ...
                        {{ $allPackageData->hotel_madinah->distance }} Meters
                      </div>
                      <div class="flex items-center mt-1 text-xs text-gray-500 dark:text-neutral-500">
                        <svg class="flex-shrink-0 size-3.5 me-2 mb-0.5" xmlns="http://www.w3.org/2000/svg"
                          width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        ...
                        {{ $allPackageData->hotel_madinah->rating }} Rating
                      </div>
                    </div>
                  </td>
                  <!-- End Hotel Madinah -->
                  ...
                  <td class="align-top size-px whitespace-nowrap">
                    <div class="py-3 ps-6">
                      <span class="text-sm text-gray-600 dark:text-neutral-400">
                        {{ $allPackageData->created_at->format('d F Y') }}
                      </span>
                    </div>
                  </td>
                  <!-- End Created -->
          ...
          <div
            ...
            <div>
              <p class="text-sm text-gray-600 dark:text-neutral-400">
                <span class="font-semibold text-gray-800 dark:text-neutral-200">{{ $allPackageData->count() }}</span>
                results
              </p>
            </div>
            <!-- End Results -->
