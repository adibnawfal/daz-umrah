<div class="relative grid max-w-4xl mx-auto space-y-5 sm:space-y-10">

  <!-- Title -->
  <div class="text-center">
    <p class="mb-3 text-xs font-semibold tracking-wide text-gray-800 uppercase">
      Dhiya Az Zahra
    </p>
    <h1 class="text-3xl font-bold text-gray-800 sm:text-5xl lg:text-6xl lg:leading-tight">
      Travel with us <span class="text-[#c31e39]"><br>Umrah 2024</span>
    </h1>
  </div>
  <!-- End Title -->
  ...
  <div class="text-center sm:flex sm:justify-center sm:items-center sm:text-start">
    <div class="flex-shrink-0 pb-5 sm:flex sm:pb-0 sm:pe-5">
      ...
      <div class="flex justify-center -space-x-3">
        <img class="inline-block rounded-full size-8 ring-2 ring-white dark:ring-gray-800"
        ...
        <img class="inline-block rounded-full size-8 ring-2 ring-white dark:ring-gray-800"
          ...
          alt="Image Description">
        <span
          class="inline-flex items-center justify-center bg-gray-800 rounded-full size-8 ring-2 ring-white dark:bg-gray-900 dark:ring-gray-800">
    ...
    <div class="w-32 h-px mx-auto border-t border-gray-200 sm:border-t-0 sm:border-s sm:w-auto sm:h-full sm:mx-0">
    </div>
  ...
  <!-- SVG Element -->
  {{-- <div class="absolute hidden transform -translate-x-40 top-2/4 start-0 -translate-y-2/4 md:block lg:-translate-x-80"
    aria-hidden="true">
    <svg class="h-auto w-52" width="717" height="653" viewBox="0 0 717 653" fill="none"
      ...
      <path
        ...
        fill="currentColor" class="fill-[#c31e39]" />
      <path
        ...
        fill="currentColor" class="fill-[#9c182e]" />
    </svg>
  </div> --}}
  <!-- End SVG Element -->

  <!-- SVG Element -->
  {{-- <div class="absolute hidden transform translate-x-40 top-2/4 end-0 -translate-y-2/4 md:block lg:translate-x-80"
    aria-hidden="true">
    <svg class="h-auto w-72" width="1115" height="636" viewBox="0 0 1115 636" fill="none"
      xmlns="http://www.w3.org/2000/svg">
      <path
