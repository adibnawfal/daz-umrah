...
<div class="grid gap-6 md:grid-cols-2 lg:gap-12">
  <div class="space-y-6 lg:space-y-10">
    <!-- Icon Block -->
    <div class="flex">
      <svg class="flex-shrink-0 mt-2 text-gray-800 size-8 dark:text-white" xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="flex">
      <svg class="flex-shrink-0 mt-2 text-gray-800 size-8 dark:text-white" xmlns="http://www.w3.org/2000/svg"
        width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
        stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-plane">
        <path
  ...
  <div class="space-y-6 lg:space-y-10">
    ...
    <div class="flex">
      <svg class="flex-shrink-0 mt-2 text-gray-800 size-8 dark:text-white" xmlns="http://www.w3.org/2000/svg"
        width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
        stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-hand-heart">
