                  ...
                  <div class="grid gap-y-4">
                    ...
                    <div>
                      ...
                      <input type="email" id="email" name="email" placeholder="Enter your email address"
                        ...
                        autocomplete="email" value="{{ old('email', $request->email) }}">
                    ...
                    <button type="submit"
                      class="inline-flex items-center justify-center w-full px-4 py-3 text-sm font-semibold text-white bg-[#c31e39] border border-transparent rounded-lg gap-x-2 hover:bg-[#9c182e] disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">Reset
                      Password</button>
                  </div>
                </form>
                <!-- End Form -->
