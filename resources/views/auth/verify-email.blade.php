          ...
          <div class="lg:max-w-lg lg:mx-auto lg:me-0 ms-auto">
            ...
            <div class="flex flex-col p-4 bg-white shadow-lg sm:p-7 rounded-2xl dark:bg-slate-900">
              <div class="text-center">
                <h1 class="block text-3xl font-bold text-gray-800 dark:text-white">Verify Email</h1>
              ...
              @if (session('status') == 'verification-link-sent')
                <div class="mt-5 text-sm font-medium text-green-600">
              ...
              <div class="mt-5">
                ...
                <form method="POST" action="{{ route('verification.send') }}">
                  ...
                  <div class="grid gap-y-4">
                    <button type="submit"
                      class="inline-flex items-center justify-center w-full px-4 py-3 text-sm font-semibold text-white bg-[#c31e39] border border-transparent rounded-lg gap-x-2 hover:bg-[#9c182e] disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">Resend
                ...
                <form method="POST" action="{{ route('logout') }}">
                  ...
                  <div class="grid gap-y-4">
                    <button type="submit"
                      class="inline-flex items-center justify-center w-full px-4 py-3 text-sm font-semibold text-white bg-[#c31e39] border border-transparent rounded-lg gap-x-2 hover:bg-[#9c182e] disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">Log
                      Out</button>
                  </div>
                </form>
                <!-- End Form -->
