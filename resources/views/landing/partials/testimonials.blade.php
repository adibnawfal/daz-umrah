...
<div class="md:grid md:grid-cols-2 md:gap-10 lg:gap-16 md:items-center">
  <div class="hidden mb-24 md:block md:mb-0 sm:px-6">
    <div class="relative">
      ...
      <div class="absolute bottom-0 start-0 -z-[1] translate-y-10 -translate-x-14">
        <svg class="h-auto max-w-40 text-slate-400 dark:text-slate-700" width="696" height="653" viewBox="0 0 696 653"
  ...
  <div>
    ...
    <blockquote class="relative">
      <svg
        class="absolute top-0 text-gray-200 transform -translate-x-8 -translate-y-4 start-0 size-24 dark:text-gray-700"
