...
<div class="lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center lg:justify-between">
  <div class="lg:col-span-5 lg:col-start-1">
    <!-- Title -->
    <div class="mb-8">
      <h2 class="mb-2 text-3xl font-bold text-gray-800 lg:text-4xl dark:text-gray-200">
  ...
  <div class="mt-10 lg:mt-0 lg:col-span-6 lg:col-end-13">
    <div class="space-y-6 sm:space-y-8">
      <!-- List -->
      <ul class="grid grid-cols-2 overflow-hidden divide-x-2 divide-y-2 divide-gray-200 dark:divide-gray-700">
        <li class="flex flex-col -m-0.5 p-4 sm:p-8">
          <div class="flex items-end mb-2 text-3xl font-bold text-gray-800 gap-x-2 sm:text-5xl dark:text-gray-200">
            540+
          </div>
        ...
        <li class="flex flex-col -m-0.5 p-4 sm:p-8">
          <div class="flex items-end mb-2 text-3xl font-bold text-gray-800 gap-x-2 sm:text-5xl dark:text-gray-200">
            <svg class="flex-shrink-0 text-[#c31e39] size-5 dark:text-[#c31e39]" xmlns="http://www.w3.org/2000/svg"
