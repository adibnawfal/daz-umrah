          ...
          <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
              <tr>
                ...
                <td class="w-auto h-px whitespace-nowrap">
                  <div class="px-6 py-2">
                    <span class="text-sm font-semibold text-gray-800 dark:text-gray-200">195</span>
              ...
              <tr>
                ...
                <td class="w-auto h-px whitespace-nowrap">
                  <div class="px-6 py-2">
                    <span class="text-sm font-semibold text-gray-800 dark:text-gray-200">99</span>
              ...
              <tr>
                <td class="w-auto h-px whitespace-nowrap">
                  <div class="flex items-center px-6 py-2 gap-x-3">
                    ...
                    <a class="flex items-center gap-x-2" href="#">
                      ...
                      <span class="text-sm text-blue-600 decoration-2 hover:underline dark:text-blue-500">United
                        States</span>
                    </a>
                  </div>
                </td>
                <td class="w-auto h-px whitespace-nowrap">
                  <div class="px-6 py-2">
                    <span class="text-sm font-semibold text-gray-800 dark:text-gray-200">96</span>
                    <span class="text-xs text-gray-500">(11.40%)</span>
                  </div>
                </td>
                <td class="w-auto h-px whitespace-nowrap">
              ...
              <tr>
                ...
                <td class="w-auto h-px whitespace-nowrap">
                  <div class="px-6 py-2">
                    <span class="text-sm font-semibold text-gray-800 dark:text-gray-200">32</span>
              ...
              <tr>
                ...
                <td class="w-auto h-px whitespace-nowrap">
                  <div class="px-6 py-2">
                    <span class="text-sm font-semibold text-gray-800 dark:text-gray-200">25</span>
              ...
              <tr>
                ...
                <td class="w-auto h-px whitespace-nowrap">
                  <div class="px-6 py-2">
                    <span class="text-sm font-semibold text-gray-800 dark:text-gray-200">24</span>
              ...
              <tr>
                <td class="w-auto h-px whitespace-nowrap">
                  <div class="flex items-center px-6 py-2 gap-x-3">
                    ...
                    <a class="flex items-center gap-x-2" href="#">
                      <svg class="size-4" xmlns="http://www.w3.org/2000/svg" id="flag-icons-fr"
                        viewBox="0 0 640 480">
                ...
                <td class="w-auto h-px whitespace-nowrap">
                  <div class="px-6 py-2">
                    <span class="text-sm font-semibold text-gray-800 dark:text-gray-200">46</span>
              ...
              <tr>
                <td class="w-auto h-px whitespace-nowrap">
                  <div class="flex items-center px-6 py-2 gap-x-3">
                    ...
                    <a class="flex items-center gap-x-2" href="#">
                      <svg class="size-4" xmlns="http://www.w3.org/2000/svg" id="flag-icons-br"
                        viewBox="0 0 640 480">
                        <g stroke-width="1pt">
                ...
                <td class="w-auto h-px whitespace-nowrap">
                  <div class="px-6 py-2">
                    <span class="text-sm font-semibold text-gray-800 dark:text-gray-200">42</span>
              ...
              <tr>
                <td class="w-auto h-px whitespace-nowrap">
                  <div class="flex items-center px-6 py-2 gap-x-3">
                    ...
                    <a class="flex items-center gap-x-2" href="#">
                      <svg class="size-4" xmlns="http://www.w3.org/2000/svg" id="flag-icons-gb"
                        viewBox="0 0 640 480">
                ...
                <td class="w-auto h-px whitespace-nowrap">
                  <div class="px-6 py-2">
                    <span class="text-sm font-semibold text-gray-800 dark:text-gray-200">30</span>
