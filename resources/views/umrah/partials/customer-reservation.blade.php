        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            @foreach ($reservation as $reservationData)
                ...
                <td class="align-top size-px whitespace-nowrap">
                  <div class="py-3 ps-6">
                    ...
                    <div class="flex items-center mt-2 text-xs text-gray-600 dark:text-neutral-400">
                      <svg class="flex-shrink-0 size-3.5 me-2 mb-0.5" xmlns="http://www.w3.org/2000/svg" width="24"
                  ...
                  <div class="py-3 ps-6">
                    @if ($reservationData->status === 'Under Review')
                      <div class="flex items-center gap-x-3">
                        <span class="text-xs text-gray-600 dark:text-neutral-400">1/4</span>
                    ...
                    @elseif ($reservationData->status === 'Update Details')
                      <div class="flex items-center gap-x-3">
                        <span class="text-xs text-gray-600 dark:text-neutral-400">2/4</span>
                        <div class="flex w-full h-1.5 bg-gray-200 rounded-full overflow-hidden dark:bg-neutral-700">
                          <div class="flex flex-col justify-center overflow-hidden bg-gray-800 dark:bg-neutral-200"
                    ...
                    @elseif ($reservationData->status === 'Make Payment')
                      <div class="flex items-center gap-x-3">
                        <span class="text-xs text-gray-600 dark:text-neutral-400">3/4</span>
                        <div class="flex w-full h-1.5 bg-gray-200 rounded-full overflow-hidden dark:bg-neutral-700">
                          <div class="flex flex-col justify-center overflow-hidden bg-gray-800 dark:bg-neutral-200"
                    ...
                    @elseif ($reservationData->status === 'Approved')
                      <div class="flex items-center gap-x-3">
                        <span class="text-xs text-gray-600 dark:text-neutral-400">4/4</span>
                        <div class="flex w-full h-1.5 bg-gray-200 rounded-full overflow-hidden dark:bg-neutral-700">
                          <div class="flex flex-col justify-center overflow-hidden bg-gray-800 dark:bg-neutral-200"
                    ...
                    <div class="hs-dropdown relative inline-block [--placement:bottom-right]">
                      ...
                      <div
                        ...
                        <div class="py-2 first:pt-0 last:pb-0">
                          <span class="block px-3 py-2 text-xs font-medium text-gray-400 uppercase dark:text-gray-600">
                            Actions
                          </span>
                          @if ($reservationData->status === 'Update Details')
              ...
              @include('umrah.partials.modal.hs-make-payment-modal')
              @include('umrah.partials.modal.hs-cancel-reservation-modal')
            @endforeach
          </tbody>
        </table>
        <!-- End Table -->
