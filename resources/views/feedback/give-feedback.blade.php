  ...
  <div class="p-4 bg-white border border-gray-200 h-max rounded-xl sm:p-7 dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="mb-8">
      ...
      <p class="text-sm text-gray-600 dark:text-gray-400">
        Provide feedback about the system and company.
      </p>
    </div>
    <!-- End Title -->

    <!-- Form -->
    <form method="post" action="{{ route('feedback.post-give-feedback') }}" enctype="multipart/form-data">
      @csrf
      ...
      <div class="grid gap-2 sm:grid-cols-12 sm:gap-6">
        ...
        <div class="sm:col-span-9">
          <div class="flex items-center" x-data="{ rating: '{{ old('rating', 0) }}' }">
